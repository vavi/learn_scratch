...
import static javaopt.queue.UnsafeDirectByteBuffer.CACHE_LINE_SIZE;
import static javaopt.queue.UnsafeDirectByteBuffer.alignedSlice;
import static javaopt.queue.UnsafeDirectByteBuffer.allocateAlignedByteBuffer;
...
public final class P1C1QueueStep5 implements Queue<Integer> {
    ...
    public P1C1QueueStep5(final int capacity) {
     ...
     * @param viewMask
     */
    public P1C1QueueStep5(final ByteBuffer buff, final int capacity,
	    byte viewMask) {
	...
	long offset = arrayBase + ((currentTail & mask) << INT_ELEMENT_SCALE);
