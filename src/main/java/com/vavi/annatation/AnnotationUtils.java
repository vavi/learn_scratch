...
public class AnnotationUtils {
	...
	public static void printAnnotationInfo() throws Exception {
		...
		for (Method method : methods) {
			...
			for (Method annotationMethod : requestMapping.getClass()
					.getMethods()) {
			...
			System.out.println("super class:"
					+ requestMapping.getClass().getSuperclass().getName());

			System.out.print("super interfaces:");

			for (Class interfaceClass : requestMapping.getClass()
					.getInterfaces()) {
			...
			System.out.println("----------------------------------");
			System.out
					.println("InvocationHandler:" + requestMapping.getClass());

			// System.out.println(requestMapping.getClass().getMethod("getProxyClass",
			// ClassLoader.class,
