...
public class AbstractServerTest {
	...
	@Test
	public void testConnectionKey() throws Exception {
		messageLatch = new CountDownLatch(1);
		messageHolder.clear();
		Socket sc = new Socket("localhost", PORT);
		OutputStream os = sc.getOutputStream();
	...
	@Test
	public void testSendOverLengthMessage() throws Exception {
	...
	@Test
	public void testSendOverDefaultLengthMessage() throws Exception {
	...
	@Test
	public void testWriteOverDefaultLengthMessage() throws Exception {
		...
		long length = new TwoByteMessageLength().bytesToLength(new byte[] {
	...
	public void testWrite() throws Exception {
		...
		byte[] compare = new byte[] { (byte) 72, (byte) 101, (byte) 108,
				(byte) 108, (byte) 111, (byte) 33, (byte) 10 };
	...
	public void testWriteOverMaxLengthMessage() throws Exception {
		messageLatch = new CountDownLatch(1);
		Socket sc = new Socket("localhost", PORT);
		OutputStream os = sc.getOutputStream();
		os.write(0);
	...
	@Test
	public void testWriteDisconnection() throws Exception {
		messageLatch = new CountDownLatch(1);
