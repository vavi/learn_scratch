...
public class TwoByteMessageLengthTest {
	...
	public void testToBytesForSingleNegative() {
		assertArrayEquals(messageLength.lengthToBytes(255),
				new byte[] { 0, -1 });
	}
	...
	public void testToBytesTwoBytesLastNegative() {
		assertArrayEquals(messageLength.lengthToBytes(1000), new byte[] { 3,
				-24 });
	}
	...
	public void testToBytesTwoBytesBothNegative() {
		assertArrayEquals(messageLength.lengthToBytes(44444), new byte[] { -83,
				-100 });
	}

	@Test
	public void testToLengthTwoBytesBothNegative() {
		assertEquals(messageLength.bytesToLength(new byte[] { -83, -100 }),
				44444);
	}

	@Test
	public void testToBytesTwoBytesFirstNegative() {
		assertArrayEquals(messageLength.lengthToBytes(51209), new byte[] { -56,
				9 });
	}
